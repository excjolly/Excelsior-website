      ...
      <div className="LearningExperience mt-3">
        <div className="row">
          <div className="col col-lg-4 col-sm-12">
            <Menu  className="back" style={{"height" : "100%" , "display" : "flex" , "flexDirection" : "column" , "justifyContent" : "space-evenly"}} >
          ...
          <div className="col col-lg-8 col-sm-12">
            <p className="mr-4 my-4 p-2"  style={{"backgroundColor" : "white"}}>
              ...
              it to make a type specimen bookLorem Ipsum is simply dummy text of
              ...
              bookLorem Ipsum is simply dummy text of the printing and
