import mentor1 from '../../../assets/images/ashutosh.png';
import mentor2 from '../../../assets/images/charuchhabra.webp';
import mentor3 from '../../../assets/images/rohinijain.webp';
import mentor4 from '../../../assets/images/shobhitgupta.webp';

export const programData = {
	features: [
		{
			title: <b>Dedicated RM</b>,
			content: ['You will be assigned a dedicated RM (Relationship Manager) for all queries.'],
		},
		{
			title: <b>Lifetime Access</b>,
			content: ['Lifetime access to content, study material, videos and our community'],
		},
		{
			title: <b>Assured Internship</b>,
		...
		{
			title: <b>Learning Analytics</b>,
			content: ['Get detailed feedbacks and know your progress as compared to other students.'],
		},
		{
			title: <b>Profile Building</b>,
			content: ['Create your professional profile as per the need of the industry.'],
		},
	],
	notifications: [
		{
			title: 'Shweta Tiwari just scored in 98th percentile in python quiz',
		},
		{
			title: 'Ankur Chawla just got 41% scholarship in the specialization program',
		},
		{
			title: 'Manik Goel just secured 100% marks in python quiz',
		},
		{
			title: 'Ankit Goel just scored in 93rd percentile in Machine Learning quiz',
		},
		{
			title: '1000 people have now completed Machine learning quiz',
		},
		{
			title: 'Shraddha Tripathi just scored in 96th percentile in python quiz',
		},
		{
			title: 'Kiara Gupta just got 36% scholarship in the Deep Learning program',
		},
		{
			title: 'Dheeraj just got 28% scholarship in the specialization program',
		},
		{
			title: 'Pavan Kumar just got 33% scholarship in the specialization program',
		},
		{
			title: 'Radhika Sharma just got 41% scholarship in the specialization program',
		},
		{
			title: 'Senthil Ramakrishna just scored in 99th percentile in python quiz',
		},
		{
			title: 'Rohan Joshi just got 29% scholarship in the Deep Learning program',
		},
		{
			title: 'Arjun Raghuvanshi just got 17% scholarship in the specialization program',
		},
		{
			title: 'Sai Teja Reddy just got 39% scholarship in the machine learning program',
		},
		{
			title: 'Suresh Ganithapelly just got 23% scholarship in the specialization program',
		},
	],
	mentors: [
		{
